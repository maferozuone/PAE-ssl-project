...
\textbf{BYOL}    & Completo (100\%) & 75\,750 & \textit{[En ejecución]} & \textit{[En ejecución]} & \textit{[Pendiente]} & \textit{[Pendiente]} \\
                 ...
                 & Aleatorio 60\% & 45\,450 & \textit{[En ejecución]} & \textit{[En ejecución]} & \textit{[Pendiente]} & \textit{[Pendiente]} \\
\midrule
\textbf{CPC}     & Completo (100\%) & 75\,750 & 184.0 min (3.07 h) & \textit{[Registrado]} & \textit{[Pendiente]} & \textit{[Pendiente]} \\
                 & SAS 80\% & 60\,600 & 141.2 min (2.35 h) & \textit{[Registrado]} & \textit{[Pendiente]} & \textit{[Pendiente]} \\
                 & SAS 60\% & 45\,450 & 104.0 min (1.73 h) & \textit{[Registrado]} & \textit{[Pendiente]} & \textit{[Pendiente]} \\
                 & Aleatorio 60\% & 45\,450 & 104.7 min (1.75 h) & \textit{[Registrado]} & \textit{[Pendiente]} & \textit{[Pendiente]} \\
\midrule
\textbf{Align-Uniform} & Completo (100\%) & 75\,750 & 281.7 min (4.70 h) & \textit{[Registrado]} & \textit{[Pendiente]} & \textit{[Pendiente]} \\
                       & SAS 80\% & 60\,600 & 223.3 min (3.72 h) & \textit{[Registrado]} & \textit{[Pendiente]} & \textit{[Pendiente]} \\
                       & SAS 60\% & 45\,450 & 170.4 min (2.84 h) & \textit{[Registrado]} & \textit{[Pendiente]} & \textit{[Pendiente]} \\
                       & Aleatorio 60\% & 45\,450 & 170.8 min (2.85 h) & \textit{[Registrado]} & \textit{[Pendiente]} & \textit{[Pendiente]} \\
\bottomrule
\end{tabular}
\end{table*}
